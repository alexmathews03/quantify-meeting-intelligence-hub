    ...
    <>
      <header className="no-print" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <Link to="/" style={{ textDecoration: 'none', color: 'var(--text-dark)', display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 900, fontSize: '1.5rem' }}>
            <span className="marker-highlight">QUANTIFY</span>
          </Link>
        </div>
